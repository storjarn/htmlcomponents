...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./LegendElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./LegendElement"));
    } else {
        // Browser globals (root is window)
        factory(root.LegendElement);
    }
}(this, function(LegendElement) {
    'use strict';

    describe('base/LegendElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(LegendElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof LegendElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(LegendElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof LegendElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
