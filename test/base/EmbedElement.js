...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./EmbedElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./EmbedElement"));
    } else {
        // Browser globals (root is window)
        factory(root.EmbedElement);
    }
}(this, function(EmbedElement) {
    'use strict';

    describe('base/EmbedElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(EmbedElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof EmbedElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(EmbedElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof EmbedElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
