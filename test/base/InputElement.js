...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./InputElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./InputElement"));
    } else {
        // Browser globals (root is window)
        factory(root.InputElement);
    }
}(this, function(InputElement) {
    'use strict';

    describe('base/InputElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(InputElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof InputElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(InputElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof InputElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
