...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TextAreaElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TextAreaElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TextAreaElement);
    }
}(this, function(TextAreaElement) {
    'use strict';

    describe('base/TextAreaElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TextAreaElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TextAreaElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TextAreaElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TextAreaElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
