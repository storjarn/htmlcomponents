...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TitleElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TitleElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TitleElement);
    }
}(this, function(TitleElement) {
    'use strict';

    describe('base/TitleElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TitleElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TitleElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TitleElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TitleElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
