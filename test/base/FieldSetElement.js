...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./FieldSetElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./FieldSetElement"));
    } else {
        // Browser globals (root is window)
        factory(root.FieldSetElement);
    }
}(this, function(FieldSetElement) {
    'use strict';

    describe('base/FieldSetElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(FieldSetElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof FieldSetElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(FieldSetElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof FieldSetElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
