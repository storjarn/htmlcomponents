...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./HRElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./HRElement"));
    } else {
        // Browser globals (root is window)
        factory(root.HRElement);
    }
}(this, function(HRElement) {
    'use strict';

    describe('base/HRElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(HRElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof HRElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(HRElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof HRElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
