...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./UListElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./UListElement"));
    } else {
        // Browser globals (root is window)
        factory(root.UListElement);
    }
}(this, function(UListElement) {
    'use strict';

    describe('base/UListElement', function() {
        ...
        it('should exist', function() {
            expect(UListElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new UListElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(UListElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof UListElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(UListElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof UListElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
