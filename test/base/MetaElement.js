...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./MetaElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./MetaElement"));
    } else {
        // Browser globals (root is window)
        factory(root.MetaElement);
    }
}(this, function(MetaElement) {
    'use strict';

    describe('base/MetaElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(MetaElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof MetaElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(MetaElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof MetaElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
