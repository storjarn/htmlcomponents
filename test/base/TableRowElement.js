...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TableRowElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TableRowElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TableRowElement);
    }
}(this, function(TableRowElement) {
    'use strict';

    describe('base/TableRowElement', function() {
        ...
        it('should exist', function() {
            expect(TableRowElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new TableRowElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TableRowElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TableRowElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TableRowElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TableRowElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
