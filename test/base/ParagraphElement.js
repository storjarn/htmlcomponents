...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ParagraphElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ParagraphElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ParagraphElement);
    }
}(this, function(ParagraphElement) {
    'use strict';

    describe('base/ParagraphElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ParagraphElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ParagraphElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ParagraphElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ParagraphElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
