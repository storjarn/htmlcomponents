...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./AnchorElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./AnchorElement"));
    } else {
        // Browser globals (root is window)
        factory(root.AnchorElement);
    }
}(this, function(AnchorElement) {
    'use strict';

    describe('base/AnchorElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(AnchorElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof AnchorElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(AnchorElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof AnchorElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
