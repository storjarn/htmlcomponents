...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./HeadElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./HeadElement"));
    } else {
        // Browser globals (root is window)
        factory(root.HeadElement);
    }
}(this, function(HeadElement) {
    'use strict';

    describe('base/HeadElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(HeadElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof HeadElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(HeadElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof HeadElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
