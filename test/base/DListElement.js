...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./DListElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./DListElement"));
    } else {
        // Browser globals (root is window)
        factory(root.DListElement);
    }
}(this, function(DListElement) {
    'use strict';

    describe('base/DListElement', function() {
        ...
        it('should exist', function() {
            expect(DListElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new DListElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(DListElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof DListElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(DListElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof DListElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
