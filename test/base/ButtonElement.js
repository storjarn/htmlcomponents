...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ButtonElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ButtonElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ButtonElement);
    }
}(this, function(ButtonElement) {
    'use strict';

    describe('base/ButtonElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ButtonElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ButtonElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ButtonElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ButtonElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
