...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./LinkElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./LinkElement"));
    } else {
        // Browser globals (root is window)
        factory(root.LinkElement);
    }
}(this, function(LinkElement) {
    'use strict';

    describe('base/LinkElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(LinkElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof LinkElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(LinkElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof LinkElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
