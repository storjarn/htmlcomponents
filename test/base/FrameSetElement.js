...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./FrameSetElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./FrameSetElement"));
    } else {
        // Browser globals (root is window)
        factory(root.FrameSetElement);
    }
}(this, function(FrameSetElement) {
    'use strict';

    describe('base/FrameSetElement', function() {
        ...
        it('should exist', function() {
            expect(FrameSetElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new FrameSetElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(FrameSetElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof FrameSetElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(FrameSetElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof FrameSetElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
