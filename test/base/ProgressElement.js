...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ProgressElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ProgressElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ProgressElement);
    }
}(this, function(ProgressElement) {
    'use strict';

    describe('base/ProgressElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ProgressElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ProgressElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ProgressElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ProgressElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
