...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./BaseElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./BaseElement"));
    } else {
        // Browser globals (root is window)
        factory(root.BaseElement);
    }
}(this, function(BaseElement) {
    'use strict';

    describe('base/BaseElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(BaseElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof BaseElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(BaseElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof BaseElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
