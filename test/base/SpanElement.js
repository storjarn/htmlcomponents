...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./SpanElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./SpanElement"));
    } else {
        // Browser globals (root is window)
        factory(root.SpanElement);
    }
}(this, function(SpanElement) {
    'use strict';

    describe('base/SpanElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(SpanElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof SpanElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(SpanElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof SpanElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
