...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./OListElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./OListElement"));
    } else {
        // Browser globals (root is window)
        factory(root.OListElement);
    }
}(this, function(OListElement) {
    'use strict';

    describe('base/OListElement', function() {
        ...
        it('should exist', function() {
            expect(OListElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new OListElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(OListElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof OListElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(OListElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof OListElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
