...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./IFrameElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./IFrameElement"));
    } else {
        // Browser globals (root is window)
        factory(root.IFrameElement);
    }
}(this, function(IFrameElement) {
    'use strict';

    describe('base/IFrameElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(IFrameElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof IFrameElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(IFrameElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof IFrameElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
