...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./VideoElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./VideoElement"));
    } else {
        // Browser globals (root is window)
        factory(root.VideoElement);
    }
}(this, function(VideoElement) {
    'use strict';

    describe('base/VideoElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(VideoElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof VideoElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(VideoElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof VideoElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
