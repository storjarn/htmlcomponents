...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./BRElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./BRElement"));
    } else {
        // Browser globals (root is window)
        factory(root.BRElement);
    }
}(this, function(BRElement) {
    'use strict';

    describe('base/BRElement', function() {
        ...
        it('should exist', function() {
            expect(BRElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new BRElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(BRElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof BRElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(BRElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof BRElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
