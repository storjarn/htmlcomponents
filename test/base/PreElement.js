...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./PreElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./PreElement"));
    } else {
        // Browser globals (root is window)
        factory(root.PreElement);
    }
}(this, function(PreElement) {
    'use strict';

    describe('base/PreElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(PreElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof PreElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(PreElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof PreElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
