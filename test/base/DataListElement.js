...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./DataListElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./DataListElement"));
    } else {
        // Browser globals (root is window)
        factory(root.DataListElement);
    }
}(this, function(DataListElement) {
    'use strict';

    describe('base/DataListElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(DataListElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof DataListElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(DataListElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof DataListElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
