...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./DialogElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./DialogElement"));
    } else {
        // Browser globals (root is window)
        factory(root.DialogElement);
    }
}(this, function(DialogElement) {
    'use strict';

    describe('base/DialogElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(DialogElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof DialogElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(DialogElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof DialogElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
