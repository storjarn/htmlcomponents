...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./OptionElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./OptionElement"));
    } else {
        // Browser globals (root is window)
        factory(root.OptionElement);
    }
}(this, function(OptionElement) {
    'use strict';

    describe('base/OptionElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(OptionElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof OptionElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(OptionElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof OptionElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
