...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./PictureElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./PictureElement"));
    } else {
        // Browser globals (root is window)
        factory(root.PictureElement);
    }
}(this, function(PictureElement) {
    'use strict';

    describe('base/PictureElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(PictureElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof PictureElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(PictureElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof PictureElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
