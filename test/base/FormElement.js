...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./FormElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./FormElement"));
    } else {
        // Browser globals (root is window)
        factory(root.FormElement);
    }
}(this, function(FormElement) {
    'use strict';

    describe('base/FormElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(FormElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof FormElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(FormElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof FormElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
