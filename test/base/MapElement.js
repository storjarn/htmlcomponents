...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./MapElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./MapElement"));
    } else {
        // Browser globals (root is window)
        factory(root.MapElement);
    }
}(this, function(MapElement) {
    'use strict';

    describe('base/MapElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(MapElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof MapElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(MapElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof MapElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
