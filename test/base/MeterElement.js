...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./MeterElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./MeterElement"));
    } else {
        // Browser globals (root is window)
        factory(root.MeterElement);
    }
}(this, function(MeterElement) {
    'use strict';

    describe('base/MeterElement', function() {
        ...
        it('should exist', function() {
            expect(MeterElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new MeterElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(MeterElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof MeterElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(MeterElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof MeterElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
