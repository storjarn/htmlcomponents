...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./FontElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./FontElement"));
    } else {
        // Browser globals (root is window)
        factory(root.FontElement);
    }
}(this, function(FontElement) {
    'use strict';

    describe('base/FontElement', function() {
        ...
        it('should exist', function() {
            expect(FontElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new FontElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(FontElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof FontElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(FontElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof FontElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
