...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./SourceElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./SourceElement"));
    } else {
        // Browser globals (root is window)
        factory(root.SourceElement);
    }
}(this, function(SourceElement) {
    'use strict';

    describe('base/SourceElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(SourceElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof SourceElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(SourceElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof SourceElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
