...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./SlotElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./SlotElement"));
    } else {
        // Browser globals (root is window)
        factory(root.SlotElement);
    }
}(this, function(SlotElement) {
    'use strict';

    describe('base/SlotElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(SlotElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof SlotElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(SlotElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof SlotElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
