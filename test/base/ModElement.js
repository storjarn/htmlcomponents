...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ModElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ModElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ModElement);
    }
}(this, function(ModElement) {
    'use strict';

    describe('base/ModElement', function() {
        ...
        it('should exist', function() {
            expect(ModElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new ModElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ModElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ModElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ModElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ModElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
