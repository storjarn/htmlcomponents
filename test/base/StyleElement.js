...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./StyleElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./StyleElement"));
    } else {
        // Browser globals (root is window)
        factory(root.StyleElement);
    }
}(this, function(StyleElement) {
    'use strict';

    describe('base/StyleElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(StyleElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof StyleElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(StyleElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof StyleElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
