...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./SelectElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./SelectElement"));
    } else {
        // Browser globals (root is window)
        factory(root.SelectElement);
    }
}(this, function(SelectElement) {
    'use strict';

    describe('base/SelectElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(SelectElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof SelectElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(SelectElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof SelectElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
