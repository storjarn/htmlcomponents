...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./DivElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./DivElement"));
    } else {
        // Browser globals (root is window)
        factory(root.DivElement);
    }
}(this, function(DivElement) {
    'use strict';

    describe('base/DivElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(DivElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof DivElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(DivElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof DivElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
