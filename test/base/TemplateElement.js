...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TemplateElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TemplateElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TemplateElement);
    }
}(this, function(TemplateElement) {
    'use strict';

    describe('base/TemplateElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TemplateElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TemplateElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TemplateElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TemplateElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
