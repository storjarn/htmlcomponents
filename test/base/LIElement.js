...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./LIElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./LIElement"));
    } else {
        // Browser globals (root is window)
        factory(root.LIElement);
    }
}(this, function(LIElement) {
    'use strict';

    describe('base/LIElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(LIElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof LIElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(LIElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof LIElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
