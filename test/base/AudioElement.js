...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./AudioElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./AudioElement"));
    } else {
        // Browser globals (root is window)
        factory(root.AudioElement);
    }
}(this, function(AudioElement) {
    'use strict';

    describe('base/AudioElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(AudioElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof AudioElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(AudioElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof AudioElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
