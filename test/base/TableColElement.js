...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TableColElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TableColElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TableColElement);
    }
}(this, function(TableColElement) {
    'use strict';

    describe('base/TableColElement', function() {
        ...
        it('should exist', function() {
            expect(TableColElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new TableColElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TableColElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TableColElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TableColElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TableColElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
