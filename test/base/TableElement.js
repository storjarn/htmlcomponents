...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TableElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TableElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TableElement);
    }
}(this, function(TableElement) {
    'use strict';

    describe('base/TableElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TableElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TableElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TableElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TableElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
