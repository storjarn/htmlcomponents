...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./OptGroupElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./OptGroupElement"));
    } else {
        // Browser globals (root is window)
        factory(root.OptGroupElement);
    }
}(this, function(OptGroupElement) {
    'use strict';

    describe('base/OptGroupElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(OptGroupElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof OptGroupElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(OptGroupElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof OptGroupElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
