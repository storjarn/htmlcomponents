...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ImageElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ImageElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ImageElement);
    }
}(this, function(ImageElement) {
    'use strict';

    describe('base/ImageElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ImageElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ImageElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ImageElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ImageElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
