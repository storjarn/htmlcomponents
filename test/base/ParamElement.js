...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ParamElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ParamElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ParamElement);
    }
}(this, function(ParamElement) {
    'use strict';

    describe('base/ParamElement', function() {
        ...
        it('should exist', function() {
            expect(ParamElement).toBeTruthy();
        });

        it('should be a constructor', function() {
            instance = new ParamElement();
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ParamElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ParamElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ParamElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ParamElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
