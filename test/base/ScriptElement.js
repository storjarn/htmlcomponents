...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./ScriptElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./ScriptElement"));
    } else {
        // Browser globals (root is window)
        factory(root.ScriptElement);
    }
}(this, function(ScriptElement) {
    'use strict';

    describe('base/ScriptElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(ScriptElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof ScriptElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(ScriptElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof ScriptElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
