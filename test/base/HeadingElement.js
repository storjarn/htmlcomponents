...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./HeadingElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./HeadingElement"));
    } else {
        // Browser globals (root is window)
        factory(root.HeadingElement);
    }
}(this, function(HeadingElement) {
    'use strict';

    describe('base/HeadingElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(HeadingElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof HeadingElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(HeadingElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof HeadingElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
