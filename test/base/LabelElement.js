...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./LabelElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./LabelElement"));
    } else {
        // Browser globals (root is window)
        factory(root.LabelElement);
    }
}(this, function(LabelElement) {
    'use strict';

    describe('base/LabelElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(LabelElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof LabelElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(LabelElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof LabelElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
