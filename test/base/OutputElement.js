...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./OutputElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./OutputElement"));
    } else {
        // Browser globals (root is window)
        factory(root.OutputElement);
    }
}(this, function(OutputElement) {
    'use strict';

    describe('base/OutputElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(OutputElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof OutputElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(OutputElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof OutputElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
