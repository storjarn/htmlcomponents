...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./BodyElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./BodyElement"));
    } else {
        // Browser globals (root is window)
        factory(root.BodyElement);
    }
}(this, function(BodyElement) {
    'use strict';

    describe('base/BodyElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(BodyElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof BodyElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(BodyElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof BodyElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
