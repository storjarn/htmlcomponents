...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./CanvasElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./CanvasElement"));
    } else {
        // Browser globals (root is window)
        factory(root.CanvasElement);
    }
}(this, function(CanvasElement) {
    'use strict';

    describe('base/CanvasElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(CanvasElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof CanvasElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(CanvasElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof CanvasElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
