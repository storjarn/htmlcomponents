...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./AreaElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./AreaElement"));
    } else {
        // Browser globals (root is window)
        factory(root.AreaElement);
    }
}(this, function(AreaElement) {
    'use strict';

    describe('base/AreaElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(AreaElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof AreaElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(AreaElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof AreaElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
