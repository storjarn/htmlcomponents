...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./QuoteElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./QuoteElement"));
    } else {
        // Browser globals (root is window)
        factory(root.QuoteElement);
    }
}(this, function(QuoteElement) {
    'use strict';

    describe('base/QuoteElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(QuoteElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof QuoteElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(QuoteElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof QuoteElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
