...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./TableCellElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./TableCellElement"));
    } else {
        // Browser globals (root is window)
        factory(root.TableCellElement);
    }
}(this, function(TableCellElement) {
    'use strict';

    describe('base/TableCellElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(TableCellElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof TableCellElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(TableCellElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof TableCellElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
