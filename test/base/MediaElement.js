...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./MediaElement"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./MediaElement"));
    } else {
        // Browser globals (root is window)
        factory(root.MediaElement);
    }
}(this, function(MediaElement) {
    'use strict';

    describe('base/MediaElement', function() {
        ...
        describe("IDataBindable", function() {
            it('~dashStyleToCamelCase() should exist', function() {
                expect(MediaElement.dashStyleToCamelCase).toBeTruthy();
                expect(typeof MediaElement.dashStyleToCamelCase === 'function').toBeTruthy();
            });

            it('~camelCaseToDashStyle() should exist', function() {
                expect(MediaElement.camelCaseToDashStyle).toBeTruthy();
                expect(typeof MediaElement.camelCaseToDashStyle === 'function').toBeTruthy();
            });
