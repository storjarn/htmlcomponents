...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.SlotElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class SlotElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLSlotElement ) ) ) ) ) ) {}

    // customElements.define('x-slot', SlotElement, {
    //     extends: 'slot'
    // });

    var SlotElement = document.registerElement('x-slot', {
        prototype: Object.create(SlotElement_.prototype),
        extends: 'slot'
    });
