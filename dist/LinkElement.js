...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.LinkElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class LinkElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLLinkElement ) ) ) ) ) ) {}

    // customElements.define('x-link', LinkElement, {
    //     extends: 'link'
    // });

    var LinkElement = document.registerElement('x-link', {
        prototype: Object.create(LinkElement_.prototype),
        extends: 'link'
    });
