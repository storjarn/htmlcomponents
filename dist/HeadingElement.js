...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.HeadingElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class HeadingElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLHeadingElement ) ) ) ) ) ) {}

    // customElements.define('x-heading', HeadingElement, {
    //     extends: 'heading'
    // });

    var HeadingElement = document.registerElement('x-heading', {
        prototype: Object.create(HeadingElement_.prototype),
        extends: 'heading'
    });
