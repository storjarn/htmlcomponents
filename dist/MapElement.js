...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.MapElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class MapElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLMapElement ) ) ) ) ) ) {}

    // customElements.define('x-map', MapElement, {
    //     extends: 'map'
    // });

    var MapElement = document.registerElement('x-map', {
        prototype: Object.create(MapElement_.prototype),
        extends: 'map'
    });
