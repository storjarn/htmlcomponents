...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.LIElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class LIElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLLIElement ) ) ) ) ) ) {}

    // customElements.define('x-li', LIElement, {
    //     extends: 'li'
    // });

    var LIElement = document.registerElement('x-li', {
        prototype: Object.create(LIElement_.prototype),
        extends: 'li'
    });
