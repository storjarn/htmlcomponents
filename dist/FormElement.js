...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.FormElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class FormElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLFormElement ) ) ) ) ) ) {}

    // customElements.define('x-form', FormElement, {
    //     extends: 'form'
    // });

    var FormElement = document.registerElement('x-form', {
        prototype: Object.create(FormElement_.prototype),
        extends: 'form'
    });
