...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.SelectElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class SelectElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLSelectElement ) ) ) ) ) ) {}

    // customElements.define('x-select', SelectElement, {
    //     extends: 'select'
    // });

    var SelectElement = document.registerElement('x-select', {
        prototype: Object.create(SelectElement_.prototype),
        extends: 'select'
    });
