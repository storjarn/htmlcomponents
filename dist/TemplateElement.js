...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.TemplateElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class TemplateElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLTemplateElement ) ) ) ) ) ) {}

    // customElements.define('x-template', TemplateElement, {
    //     extends: 'template'
    // });

    var TemplateElement = document.registerElement('x-template', {
        prototype: Object.create(TemplateElement_.prototype),
        extends: 'template'
    });
