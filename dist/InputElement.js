...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.InputElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class InputElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLInputElement ) ) ) ) ) ) {}

    // customElements.define('x-input', InputElement, {
    //     extends: 'input'
    // });

    var InputElement = document.registerElement('x-input', {
        prototype: Object.create(InputElement_.prototype),
        extends: 'input'
    });
