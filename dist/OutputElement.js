...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.OutputElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class OutputElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLOutputElement ) ) ) ) ) ) {}

    // customElements.define('x-output', OutputElement, {
    //     extends: 'output'
    // });

    var OutputElement = document.registerElement('x-output', {
        prototype: Object.create(OutputElement_.prototype),
        extends: 'output'
    });
