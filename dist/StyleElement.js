...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.StyleElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class StyleElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLStyleElement ) ) ) ) ) ) {}

    // customElements.define('x-style', StyleElement, {
    //     extends: 'style'
    // });

    var StyleElement = document.registerElement('x-style', {
        prototype: Object.create(StyleElement_.prototype),
        extends: 'style'
    });
