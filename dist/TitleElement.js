...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.TitleElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class TitleElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLTitleElement ) ) ) ) ) ) {}

    // customElements.define('x-title', TitleElement, {
    //     extends: 'title'
    // });

    var TitleElement = document.registerElement('x-title', {
        prototype: Object.create(TitleElement_.prototype),
        extends: 'title'
    });
