...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.AreaElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class AreaElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLAreaElement ) ) ) ) ) ) {}

    // customElements.define('x-area', AreaElement, {
    //     extends: 'area'
    // });

    var AreaElement = document.registerElement('x-area', {
        prototype: Object.create(AreaElement_.prototype),
        extends: 'area'
    });
