...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.MediaElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class MediaElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLMediaElement ) ) ) ) ) ) {}

    // customElements.define('x-media', MediaElement, {
    //     extends: 'media'
    // });

    var MediaElement = document.registerElement('x-media', {
        prototype: Object.create(MediaElement_.prototype),
        extends: 'media'
    });
