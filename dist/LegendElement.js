...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.LegendElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class LegendElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLLegendElement ) ) ) ) ) ) {}

    // customElements.define('x-legend', LegendElement, {
    //     extends: 'legend'
    // });

    var LegendElement = document.registerElement('x-legend', {
        prototype: Object.create(LegendElement_.prototype),
        extends: 'legend'
    });
