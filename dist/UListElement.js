...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.UListElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class UListElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLUListElement ) ) ) ) ) ) {}

    // customElements.define('x-ul', UListElement, {
    //     extends: 'ul'
    // });

    var UListElement = document.registerElement('x-ul', {
        prototype: Object.create(UListElement_.prototype),
        extends: 'ul'
    });
