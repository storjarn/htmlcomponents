...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.ObjectElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class ObjectElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLObjectElement ) ) ) ) ) ) {}

    // customElements.define('x-object', ObjectElement, {
    //     extends: 'object'
    // });

    var ObjectElement = document.registerElement('x-object', {
        prototype: Object.create(ObjectElement_.prototype),
        extends: 'object'
    });
