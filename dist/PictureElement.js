...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.PictureElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class PictureElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLPictureElement ) ) ) ) ) ) {}

    // customElements.define('x-picture', PictureElement, {
    //     extends: 'picture'
    // });

    var PictureElement = document.registerElement('x-picture', {
        prototype: Object.create(PictureElement_.prototype),
        extends: 'picture'
    });
