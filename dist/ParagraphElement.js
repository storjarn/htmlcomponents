...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.ParagraphElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class ParagraphElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLParagraphElement ) ) ) ) ) ) {}

    // customElements.define('x-p', ParagraphElement, {
    //     extends: 'p'
    // });

    var ParagraphElement = document.registerElement('x-p', {
        prototype: Object.create(ParagraphElement_.prototype),
        extends: 'p'
    });
