...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.TrackElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class TrackElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLTrackElement ) ) ) ) ) ) {}

    // customElements.define('x-track', TrackElement, {
    //     extends: 'track'
    // });

    var TrackElement = document.registerElement('x-track', {
        prototype: Object.create(TrackElement_.prototype),
        extends: 'track'
    });
