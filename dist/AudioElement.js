...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.AudioElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class AudioElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLAudioElement ) ) ) ) ) ) {}

    // customElements.define('x-audio', AudioElement, {
    //     extends: 'audio'
    // });

    var AudioElement = document.registerElement('x-audio', {
        prototype: Object.create(AudioElement_.prototype),
        extends: 'audio'
    });
