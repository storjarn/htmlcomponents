...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.VideoElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class VideoElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLVideoElement ) ) ) ) ) ) {
        get test() {
            return true;
        }
    }

    // customElements.define('x-video', VideoElement, {
    //     extends: 'video'
    // });

    var VideoElement = document.registerElement('x-video', {
        prototype: Object.create(VideoElement_.prototype),
        extends: 'video'
    });
