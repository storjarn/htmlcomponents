...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.EmbedElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class EmbedElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLEmbedElement ) ) ) ) ) ) {}

    // customElements.define('x-embed', EmbedElement, {
    //     extends: 'embed'
    // });

    var EmbedElement = document.registerElement('x-embed', {
        prototype: Object.create(EmbedElement_.prototype),
        extends: 'embed'
    });
