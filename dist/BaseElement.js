...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.BaseElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class BaseElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLBaseElement ) ) ) ) ) ) {}

    // customElements.define('x-base', BaseElement, {
    //     extends: 'base'
    // });

    var BaseElement = document.registerElement('x-base', {
        prototype: Object.create(BaseElement_.prototype),
        extends: 'base'
    });
