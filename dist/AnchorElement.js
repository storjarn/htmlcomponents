...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.AnchorElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class AnchorElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLAnchorElement ) ) ) ) ) ) {}

    // customElements.define('x-a', AnchorElement, {
    //     extends: 'a'
    // });

    var AnchorElement = document.registerElement('x-a', {
        prototype: Object.create(AnchorElement_.prototype),
        extends: 'a'
    });
