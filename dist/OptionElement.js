...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.OptionElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class OptionElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLOptionElement ) ) ) ) ) ) {}

    // customElements.define('x-option', OptionElement, {
    //     extends: 'option'
    // });

    var OptionElement = document.registerElement('x-option', {
        prototype: Object.create(OptionElement_.prototype),
        extends: 'option'
    });
