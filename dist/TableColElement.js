...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.TableColElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class TableColElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLTableColElement ) ) ) ) ) ) {}

    // customElements.define('x-col', TableColElement, {
    //     extends: 'col'
    // });

    var TableColElement = document.registerElement('x-col', {
        prototype: Object.create(TableColElement_.prototype),
        extends: 'col'
    });
