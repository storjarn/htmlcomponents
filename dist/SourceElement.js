...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.SourceElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class SourceElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLSourceElement ) ) ) ) ) ) {}

    // customElements.define('x-source', SourceElement, {
    //     extends: 'source'
    // });

    var SourceElement = document.registerElement('x-source', {
        prototype: Object.create(SourceElement_.prototype),
        extends: 'source'
    });
