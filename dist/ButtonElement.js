...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.ButtonElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class ButtonElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLButtonElement ) ) ) ) ) ) {}

    // customElements.define('x-button', ButtonElement, {
    //     extends: 'button'
    // });

    var ButtonElement = document.registerElement('x-button', {
        prototype: Object.create(ButtonElement_.prototype),
        extends: 'button'
    });
