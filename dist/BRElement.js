...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.BRElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class BRElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLBRElement ) ) ) ) ) ) {}

    // customElements.define('x-br', BRElement, {
    //     extends: 'br'
    // });

    var BRElement = document.registerElement('x-br', {
        prototype: Object.create(BRElement_.prototype),
        extends: 'br'
    });
