...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.HeadElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class HeadElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLHeadElement ) ) ) ) ) ) {}

    // customElements.define('x-head', HeadElement, {
    //     extends: 'head'
    // });

    var HeadElement = document.registerElement('x-head', {
        prototype: Object.create(HeadElement_.prototype),
        extends: 'head'
    });
