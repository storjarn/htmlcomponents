...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.FontElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class FontElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLFontElement ) ) ) ) ) ) {}

    // customElements.define('x-font', FontElement, {
    //     extends: 'font'
    // });

    var FontElement = document.registerElement('x-font', {
        prototype: Object.create(FontElement_.prototype),
        extends: 'font'
    });
