...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.TableRowElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class TableRowElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLTableRowElement ) ) ) ) ) ) {}

    // customElements.define('x-tr', TableRowElement, {
    //     extends: 'tr'
    // });

    var TableRowElement = document.registerElement('x-tr', {
        prototype: Object.create(TableRowElement_.prototype),
        extends: 'tr'
    });
