...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.ScriptElement = factory(root.IElement, root.IEventUpgrade, root.IIdentifiable, root.IDataBindable, root.IDisposable, root.IEditable);
    }
}(this, function(IElement, IEventUpgrade, IIdentifiable, IDataBindable, IDisposable, IEditable) {
    'use strict';

    class ScriptElement_ extends IEditable( IDisposable( IDataBindable( IIdentifiable( IEventUpgrade( IElement( HTMLScriptElement ) ) ) ) ) ) {}

    // customElements.define('x-script', ScriptElement, {
    //     extends: 'script'
    // });

    var ScriptElement = document.registerElement('x-script', {
        prototype: Object.create(ScriptElement_.prototype),
        extends: 'script'
    });
